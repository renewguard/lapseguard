...
const STEPS = [
  ...
  },
  {
    icon: Radar,
    step: '02',
    title: 'RenewGuard watches every date',
    ...
    <section className="py-24 sm:py-32">
      <Container>
        <SectionHeading
          ...
          description="RenewGuard replaces the spreadsheet, the sticky note, and the calendar reminder you ignore — with one system that never forgets."
        />
