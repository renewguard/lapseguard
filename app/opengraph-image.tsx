...
export const alt = 'RenewGuard \u2014 Never miss a license, permit, or insurance renewal';
    ...
    (
      <div
        ...
        backgroundColor: '#0B0E14',
          backgroundImage:
            'radial-gradient(circle at 15% 10%, rgba(41,84,255,0.35), transparent 55%)',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <span style={{ color: 'white', fontSize: 32, fontWeight: 700 }}>RenewGuard</span>
        </div>
        <div
          style={{
            marginTop: 48,
