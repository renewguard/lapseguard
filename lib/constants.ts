...
export const FEATURES: Feature[] = [
  ...
  { icon: Repeat, title: 'Smart recurring renewals', description: 'RenewGuard learns each renewal\u2019s cycle and pre-fills the next due date the moment one closes.' },
...
export const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      'We used to track renewals in a spreadsheet that nobody opened. RenewGuard caught a liability policy that would have lapsed two weeks before our biggest job of the year.',
    name: 'Dana Whitfield',
  ...
  {
    quote:
      'With forty field technicians across three states, license expirations were our biggest legal exposure. RenewGuard turned that into a non-issue.',
...
export const FAQ_ITEMS: FAQItem[] = [
  {
    question: 'What exactly does RenewGuard track?',
    answer:
      'Anything with an expiration date that matters to your business: professional licenses, certifications, permits, insurance policies, contracts, and any internal compliance deadline you define. If it can lapse, RenewGuard can watch it.',
  },
  {
